...
Revision ID: 609f0515406e
Revises: 
Create Date: 2025-07-07 23:25:21.256454
...
def upgrade() -> None:
    ...
    op.add_column('technical_indicators', sa.Column('asset_id', sa.Integer(), nullable=False))
    op.add_column('technical_indicators', sa.Column('timeframe', sa.String(), nullable=False))
    op.add_column('technical_indicators', sa.Column('value', sa.Float(), nullable=True))
    op.add_column('technical_indicators', sa.Column('calculated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True))
    op.alter_column('technical_indicators', 'parameters',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True)
    op.drop_constraint(op.f('technical_indicators_symbol_indicator_type_timestamp_interv_key'), 'technical_indicators', type_='unique')
    op.create_index(op.f('ix_technical_indicators_id'), 'technical_indicators', ['id'], unique=False)
    op.create_foreign_key(None, 'technical_indicators', 'assets', ['asset_id'], ['id'])
    op.drop_column('technical_indicators', 'symbol')
    op.drop_column('technical_indicators', 'timestamp')
    op.drop_column('technical_indicators', 'interval')
    op.drop_column('technical_indicators', 'values')
    op.drop_column('technical_indicators', 'calculation_method')
    ...
    op.add_column('trades', sa.Column('trading_session_id', sa.Integer(), nullable=True))
    op.add_column('trades', sa.Column('trade_type', sa.String(), nullable=False))
    op.add_column('trades', sa.Column('price', sa.Float(), nullable=False))
    op.add_column('trades', sa.Column('total_value', sa.Float(), nullable=False))
    op.add_column('trades', sa.Column('fee', sa.Float(), nullable=True))
    op.add_column('trades', sa.Column('is_profitable', sa.Boolean(), nullable=True))
    op.add_column('trades', sa.Column('notes', sa.Text(), nullable=True))
    op.add_column('trades', sa.Column('trade_metadata', sa.JSON(), nullable=True))
    op.add_column('trades', sa.Column('executed_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True))
    ...
    op.alter_column('trades', 'profit_loss',
               existing_type=sa.NUMERIC(precision=18, scale=8),
               type_=sa.Float(),
               existing_nullable=True)
    op.alter_column('trades', 'profit_loss_percentage',
    ...
    op.create_foreign_key(None, 'trades', 'trading_sessions', ['trading_session_id'], ['id'])
    op.drop_column('trades', 'additional_data')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('trades', sa.Column('entry_time', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True))
    op.add_column('trades', sa.Column('stop_loss', sa.NUMERIC(precision=18, scale=8), autoincrement=False, nullable=True))
    op.add_column('trades', sa.Column('exit_time', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('trades', sa.Column('take_profit', sa.NUMERIC(precision=18, scale=8), autoincrement=False, nullable=True))
    op.add_column('trades', sa.Column('strategy_used', sa.VARCHAR(length=50), autoincrement=False, nullable=True))
    op.add_column('trades', sa.Column('entry_price', sa.NUMERIC(precision=18, scale=8), autoincrement=False, nullable=False))
    op.add_column('trades', sa.Column('symbol', sa.VARCHAR(length=20), autoincrement=False, nullable=False))
    op.add_column('trades', sa.Column('exit_price', sa.NUMERIC(precision=18, scale=8), autoincrement=False, nullable=True))
    op.add_column('trades', sa.Column('operation_type', sa.VARCHAR(length=10), autoincrement=False, nullable=False))
    op.add_column('trades', sa.Column('additional_data', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True))
    ...
    op.drop_column('trades', 'is_profitable')
    op.drop_column('trades', 'fee')
    op.drop_column('trades', 'total_value')
    op.drop_column('trades', 'price')
    op.drop_column('trades', 'trade_type')
    op.drop_column('trades', 'trading_session_id')
    op.drop_column('trades', 'asset_id')
    op.drop_column('trades', 'user_id')
    op.add_column('technical_indicators', sa.Column('calculation_method', sa.VARCHAR(length=50), autoincrement=False, nullable=True))
    op.add_column('technical_indicators', sa.Column('values', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False))
    op.add_column('technical_indicators', sa.Column('interval', sa.VARCHAR(length=10), autoincrement=False, nullable=False))
    op.add_column('technical_indicators', sa.Column('timestamp', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False))
    op.add_column('technical_indicators', sa.Column('symbol', sa.VARCHAR(length=20), autoincrement=False, nullable=False))
    ...
    op.create_unique_constraint(op.f('technical_indicators_symbol_indicator_type_timestamp_interv_key'), 'technical_indicators', ['symbol', 'indicator_type', 'timestamp', 'interval'], postgresql_nulls_not_distinct=False)
    op.alter_column('technical_indicators', 'parameters',
               existing_type=sa.JSON(),
               type_=postgresql.JSONB(astext_type=sa.Text()),
               existing_nullable=True)
    op.drop_column('technical_indicators', 'calculated_at')
    op.drop_column('technical_indicators', 'value')
    op.drop_column('technical_indicators', 'timeframe')
    op.drop_column('technical_indicators', 'asset_id')
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('symbol', sa.VARCHAR(length=20), autoincrement=False, nullable=False),
    sa.Column('open_price', sa.NUMERIC(precision=18, scale=8), autoincrement=False, nullable=False),
    sa.Column('high_price', sa.NUMERIC(precision=18, scale=8), autoincrement=False, nullable=False),
    sa.Column('low_price', sa.NUMERIC(precision=18, scale=8), autoincrement=False, nullable=False),
    sa.Column('close_price', sa.NUMERIC(precision=18, scale=8), autoincrement=False, nullable=False),
    sa.Column('volume', sa.NUMERIC(precision=24, scale=8), autoincrement=False, nullable=False),
    sa.Column('quote_asset_volume', sa.NUMERIC(precision=24, scale=8), autoincrement=False, nullable=True),
    sa.Column('number_of_trades', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('taker_buy_base_volume', sa.NUMERIC(precision=24, scale=8), autoincrement=False, nullable=True),
    sa.Column('taker_buy_quote_volume', sa.NUMERIC(precision=24, scale=8), autoincrement=False, nullable=True),
    ...
    sa.UniqueConstraint('symbol', 'timestamp', 'interval', name=op.f('price_history_symbol_timestamp_interval_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
